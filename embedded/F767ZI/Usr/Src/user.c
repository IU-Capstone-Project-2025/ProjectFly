...
void printMeasurements() {
	...
	int scaledC = 0;
	double scaled;
	comprint(buf, sprintf(buf, "\033[J\033[H"));
	for (int i = 0; i < SENSOR_LINES; ++i) {
		if (activeN[i]) {
			++scaledC;
